...
- **Image support** for food listings with fallback handling
...
2. **Add food listings** with name, description, and images
...
- `POST /api/food` - Create new food listing (Hostel only)
